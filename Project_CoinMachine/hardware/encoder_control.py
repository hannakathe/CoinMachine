...
class EncoderControl:
    def __init__(self, encoder_pin, brake_button_pin, pulses_end):
        ...
        # Configuración del botón de frenado
        ...
        self.pulse_count = 0
        self.pulses_end = pulses_end  # Número de pulsos que representa el final del recorrido
        self.brake_triggered = False  # Estado del botón de frenado
    ...
    def _brake_button_pressed(self, pin):
        ...
        if self.is_at_start():  # Solo activar el frenado si estamos en la posición inicial
